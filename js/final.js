...
function seperateEvenOdd(NumberArray){
    const evenArray =[];
    let evenIndex = 0;
    const OddArray = [];
    let OddIndex = 0;
...
// console.log(seperateEvenOdd(points));
...
// console.log(square(8," x"));
const size = 8; // Define the size of the chessboard (8x8)
...
for (let i = 0; i < size; i++) {
    ...
    for (let j = 0; j < size; j++) {
        if ((i + j) % 2 === 0) {
            row += '█'; // Black square (you can use any character you like)
        } else {
            row += '-'; // White square
        }
    }
...
// let student1MarkTotal = 0;
// let overAll = "passed";
// for (x of student1Mark){
//     // console.log(x.subject,x.mark);
//     student1MarkTotal += x.mark
//     // x.result = x.mark >= 40 ? "passed" : "failed"
//     if(x.mark >= 40){
//         x.result = "passed"
//     }else{
//         // x.result = "failed"
//         // overAll = "failed"
//         x.result = overAll ="failed"
//     }
// }
// console.table(student1Mark);
// console.log("total",student1MarkTotal);
// console.log("Over All",overAll);

// console.log(allStudentsMark);
for(student of allStudentsMark){
    student.overall = "passed"
